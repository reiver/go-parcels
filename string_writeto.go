...
func (parcel *internalStringParcel) WriteTo(w io.Writer) (int64, error) {
...
func (parcel *internalStringParcel) smallWriteTo(w io.Writer) (int64, error) {
...
func (parcel *internalStringParcel) bigWriteTo(w io.Writer) (int64, error) {
